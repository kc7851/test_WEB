<div id="bbsview">
	...
	<div class="bottom">
		<?php if($d['theme']['use_reply']):?><span><a href="<?php echo $g['bbs_reply'].$R['uid']?>"><img src="<?php echo $g['img_module_skin']?>/re_btn.jpg"></a></span><?php endif?>
		<span><a href="<?php echo $g['bbs_delete'].$R['uid']?>" target="_action_frame_<?php echo $m?>" onclick="return confirm('정말로 삭제하시겠습니까?');"><img src="<?php echo $g['img_module_skin']?>/del_btn.jpg"></a></span>
		<span><a href="<?php echo $g['bbs_modify'].$R['uid']?>"><img src="<?php echo $g['img_module_skin']?>/mod_btn.jpg"></a></span>
		<span><a href="<?php echo $g['bbs_list']?>"><img src="<?php echo $g['img_module_skin']?>/list_btn.jpg"></a></span>
	</div>
