<div id="bbslist">
	...
	<div class="bottom">
		...
		<?php if($B['uid']):?><?php if($my['uid']==1){?>
			...
			<!--<span class="btn00"><a href="<?php echo $g['bbs_write']?>">글쓰기</a></span>-->
			<span><a href="<?php echo $g['bbs_write']?>"><input type="button" value="글쓰기" class="btnnavy" /></a></span>
	...
	<div class="searchform">
		...
		<input type="submit" value=" 검색 " class="btnnavy" />
		<?php endif?>
		</form>
	</div>
