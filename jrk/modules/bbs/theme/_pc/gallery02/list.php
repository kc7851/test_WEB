<div id="bbslist">
	...
	<div class="gallery">
		...
		<div class="picbox" style="width:<?php echo $d['theme']['picwidth']+6?>px;height:<?php echo $d['theme']['picheight']+80?>px;">
			<div class="pic" style="height:<?php echo $d['theme']['picheight']?>px;">
				<a href="<?php echo $g['bbs_view'].$R['uid']?>"><?php if($_thumbimg):?><img src="<?php echo $_thumbimg?>" style="width:<?php echo $d['theme']['picwidth']?>px;height:<?php echo $d['theme']['picheight']?>px;" alt="" /><?php endif?></a>
			</div>
			<div class="sbjx">				
	...
	<div class="bottom">
		<div class="btnbox1">
		<?php if($B['uid']):?><?php if($my['uid']==1){?>
			<span><a href="<?php echo $g['bbs_write']?>"><input type="button" value="제품등록" class="btnnavy" /></a></span>
		<?php }?><?php endif?>
		</div>
		<div class="btnbox2">
		<span class="btn00"></span>
		<span class="btn00"></span>
		</div>
		<div class="clear"></div>
		<div class="pagebox01">
