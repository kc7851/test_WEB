	...
	<div class="agreebox">
		<div id="bagree1">
			...
			<div class="submitbox">
				...
				<input type="submit" value="<?php echo $d['member']['login_emailid']?'이메일':'아이디'?>찾기" class="btn w111 blue" />
			</div>
		...
		<div id="bagree2" class="hide">
			...
			<div class="submitbox">
				<input type="button" value="취소" class="btn w76 gray" onclick="goHref('<?php echo RW(0)?>');" />
				<input type="submit" value="<?php echo $d['member']['login_emailid']?'이메일':'아이디'?> 인증요청" class="btn w111 blue" />
			</div>
			</div>
			...
			<div class="submitbox">
				<input type="button" value="취소" class="btn w76 gray" onclick="goHref('<?php echo RW(0)?>');" />
				<input type="submit" value="답변 인증요청" class="btn w111 blue" />
			</div>
			</div>
			...
			<div class="submitbox">
				<input type="button" value="취소" class="btn w76 gray" onclick="goHref('<?php echo RW(0)?>');" />
				<input type="submit" value="새 비밀번호 등록" class="btn w111 blue" />
			</div>
			</div>
			</form>
		</div>
		...
		<div class="submitbox">
			<input type="button" value="취소" class="btn w76 gray" onclick="goHref('<?php echo RW(0)?>');" />
			<input type="submit" value="비밀번호 요청" class="btn w111 blue" />
		</div>
