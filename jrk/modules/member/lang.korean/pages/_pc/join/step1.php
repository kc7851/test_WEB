...
<div id="pages_join">
	...
	<div class="submitbox">
		<input type="button" value="가입취소" class="btn w76 gray" onclick="goHref('<?php echo RW(0)?>');" />
		<?php if($d['member']['form_comp']&&!$d['member']['form_jumin']):?>
		<input type="button" value="개인회원가입" class="btn w111 blue" onclick="return nextStep(0);" />
		<input type="button" value="기업회원가입" class="btn w111 blue" onclick="return nextStep(1);" />
		<?php else:?>
		<input type="button" value="다음단계" class="btn w76 blue" onclick="return nextStep(0);" />
		<?php endif?>
